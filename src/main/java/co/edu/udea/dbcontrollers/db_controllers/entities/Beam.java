...
public class Beam {
    ...
    private String projectName; // Nombre del proyecto asociado a la viga
    ...
    @Column(name = "E", nullable = true) // Módulo de Young
    private Double E;

    @Column(name = "I", nullable = true) // Momento de Inercia
    private Double I;
